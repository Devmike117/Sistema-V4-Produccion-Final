...
const API_BASE_URL = process.env.REACT_APP_API_URL || 'http://192.168.137.22:5000';

// Define la URL base de tu backend de embeddings (Python/embeddings)
// Cambia la IP si este servicio corre en otra máquina.
const EMBEDDING_API_URL = process.env.REACT_APP_EMBEDDING_API_URL || 'http://192.168.137.22:8001';
